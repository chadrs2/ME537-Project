...
echo_and_run cd "/home/chadsrover/robotics_ws/src/rad_baxter_limb"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chadsrover/robotics_ws/src/rad_baxter_limb/setup.py" \
     \
    build --build-base "/home/chadsrover/robotics_ws/build/rad_baxter_limb" \
    install \
    --root="${DESTDIR-/}" \
