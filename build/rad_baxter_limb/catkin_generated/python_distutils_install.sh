...
echo_and_run cd "/home/aaron/repos/ME537-Project/src/rad_baxter_limb"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/aaron/repos/ME537-Project/src/rad_baxter_limb/setup.py" \
     \
    build --build-base "/home/aaron/repos/ME537-Project/build/rad_baxter_limb" \
    install \
    --root="${DESTDIR-/}" \
