...
echo_and_run cd "/home/chadsrover/robotics_ws/src/baxter_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/chadsrover/robotics_ws/src/baxter_interface/setup.py" \
     \
    build --build-base "/home/chadsrover/robotics_ws/build/baxter_interface" \
    install \
    --root="${DESTDIR-/}" \
