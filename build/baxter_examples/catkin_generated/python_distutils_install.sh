...
echo_and_run cd "/home/aaron/repos/ME537-Project/src/baxter_examples"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/aaron/repos/ME537-Project/src/baxter_examples/setup.py" \
     \
    build --build-base "/home/aaron/repos/ME537-Project/build/baxter_examples" \
    install \
    --root="${DESTDIR-/}" \
