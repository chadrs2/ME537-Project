...
echo_and_run cd "/home/aaron/repos/ME537-Project/src/baxter_pykdl"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/aaron/repos/ME537-Project/src/baxter_pykdl/setup.py" \
     \
    build --build-base "/home/aaron/repos/ME537-Project/build/baxter_pykdl" \
    install \
    --root="${DESTDIR-/}" \
