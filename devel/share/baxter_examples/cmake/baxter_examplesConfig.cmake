...
if("TRUE" STREQUAL "TRUE")
  set(baxter_examples_SOURCE_PREFIX /home/chad_samuelson/ME537-Project/src/baxter_examples)
  set(baxter_examples_DEVEL_PREFIX /home/chad_samuelson/ME537-Project/devel)
  ...
  set(baxter_examples_INSTALL_PREFIX /home/chad_samuelson/ME537-Project/install)
...
if(NOT "/home/chad_samuelson/ME537-Project/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'baxter_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chad_samuelson/ME537-Project/src/baxter_examples/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT baxter_examples_NUM_DUMMY_TARGETS)
      set(baxter_examples_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::baxter_examples::wrapped-linker-option${baxter_examples_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR baxter_examples_NUM_DUMMY_TARGETS "${baxter_examples_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::baxter_examples::wrapped-linker-option${baxter_examples_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND baxter_examples_LIBRARIES "${interface_target_name}")
