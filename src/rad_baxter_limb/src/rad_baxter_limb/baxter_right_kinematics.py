...
#
    ...
    x27 = x23*x26
    x28 = 0.01*cos(q[4])
    x29 = x28*(x14*x20 + x17*x8)
    x30 = x11*x7
    x31 = x10*x14
    x32 = x3*x7
    x33 = x17*x30
    x34 = x23*x32 + x28*(x10*x17 - x14*x30) - 0.37429*x31 - 0.37429*x33
    ...
    x43 = -x10*x24 + x25
    x44 = x17*x43
    x45 = x23*x42 + x28*(x14*x43 - x17*x40) + 0.37429*x41 + 0.37429*x44
    x46 = -x12*x5 + x2*x3 + 0.36435*x40 + x45
    x47 = x41 + x44
#
    jacobian[0] = -x13 + x16 + x2 - x22 - x27 - x29 - x6 + x9
    jacobian[1] = x35*x4
    jacobian[2] = x10*x37 - x35*x8
    jacobian[3] = x26*x34 - x32*x36
...
#
    ...
    x36 = x17*x33
    x37 = x10*x17 - x14*x33
    x38 = x24*x35 + x30*x37 - 0.37429*x34 - 0.37429*x36
    ...
    x48 = x17*x47
    x49 = x14*x47 - x17*x44
    x50 = x24*x46 + x30*x49 + 0.37429*x45 + 0.37429*x48
