...
def extractColors(hsv):
    blue_low = np.array([100, 50, 50]) #110
    blue_high = np.array([130, 255, 255]) #150

    red_low = np.array([10, 10, 10]) #10
    red_high = np.array([150, 255, 255]) #150

    green_low = np.array([50, 50, 50]) #60 40
    green_high = np.array([100, 255, 255]) #90 110
...
def findTomatoes(img1_b, img1_g, img1_r):
    ...
    max_b = np.max(img1_b[0:10])
    max_r = np.max(img1_r[0:10])
    max_g = np.max(img1_g[0:10])
